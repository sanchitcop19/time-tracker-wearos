 ...
 */
public class ProjectPickerLayout extends LinearLayout
    ...
    public ProjectPickerLayout(Context context) {
        this(context, null);
    }

    public ProjectPickerLayout(Context context, AttributeSet attrs) {
